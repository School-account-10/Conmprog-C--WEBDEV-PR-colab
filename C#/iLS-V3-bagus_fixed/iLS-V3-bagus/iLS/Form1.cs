    ...
    public partial class Form1 : Form
    {
        ...
        { // changed the logic to not make this as long cuz this used too many if-else statements 
            ...
            try
            {
                ...
                //string fullPath = Path.GetFullPath("C:\\Users\\Franzoli\\Desktop\\Coding\\Vscode\\Computer-ils\\gr12-ils\\Conmprog-C--WEBDEV-PR-colab\\C#\\iLS-V3-bagus_fixed\\iLS-V3-bagus\\iLS\\Resources\\symptomsDB\\symptoms.json"); 
                
                
                string fullPath = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\\..\\..\\Resources\\symptomsDB\\symptoms.json"));// kill me already stackoverflow saves the day // UPDATE DID NOT WORK //now it works yay
                ...
                else
                {
                    ...
                    MessageBox.Show(
                    $"No DB file found!\n(current read: {fullPath})\n\nDev fix: PUT symptoms.json in the resources folder! TODO: remove before research lol",
                    "DB Error: Line 140",
